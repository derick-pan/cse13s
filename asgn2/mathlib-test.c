...
int main(int argc, char *argv[]) {
    ...
    if (flaga == 1
        || flags
               == 1) { //If all test's flag or arcsin flag is ==1, then print values from -1 to 1, w/ step 0.1
    ...
    if (flaga == 1
        || flagc
               == 1) { //If all test's flag or arccos flag is ==1, then print values from -1 to 1, w/ step 0.1
    ...
    if (flaga == 1
        || flagt
               == 1) { //If all test's flag or acrcos flag is ==1, then print values from 1 to 10, w/ step 0.1
    ...
    if (flaga == 1
        || flagl
               == 1) { //If all test's flag or log flag is ==1, then print values from 1 to 10, w/ step 0.1
